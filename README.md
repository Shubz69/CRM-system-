...
Docs: [SETUP](docs/SETUP.md) · [MIGRATIONS](docs/MIGRATIONS.md) · [SUPABASE](docs/SUPABASE.md) · [VERCEL](docs/VERCEL.md) · [ADMIN](docs/ADMIN.md) · [MANYCHAT](docs/MANYCHAT.md) · [SOCIAL_CONNECTIONS](docs/SOCIAL_CONNECTIONS.md) · [AI_PROVIDERS](docs/AI_PROVIDERS.md) · [AI_AGENT](docs/AI_AGENT.md) · [KNOWLEDGE](docs/KNOWLEDGE.md) · [BOOKINGS](docs/BOOKINGS.md) · [SECURITY](docs/SECURITY.md) · [TESTING](docs/TESTING.md) · [DEPLOYMENT](docs/DEPLOYMENT.md) · [WORKER](docs/WORKER.md)
...
**Bootstrap** (platform org + your admin — no demo tenants):
